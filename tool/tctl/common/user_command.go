...
Please create a role and use new format with --roles flag:

$ tctl users add %v --roles=[add your role here]

We are going to deprecate old format in the next release of Teleport.
Meanwhile we assign %v user to %v role we created during migration.
